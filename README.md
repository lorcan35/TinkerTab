...
🌐 **Documentation site:** http://tinker.local on the LAN — Watcher-styled Docusaurus site with the full user + developer docs ([source](docs-site/)). Build + LAN-deploy via Caddy on the DGX device:
