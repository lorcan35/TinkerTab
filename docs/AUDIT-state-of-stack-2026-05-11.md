...
**Remaining roadmap:** W7-C memory bridge · W7-B.2 dynamic skill discovery (WS-RPC, the meta-prerequisite for W7-B.2/C/D/F) · W7-0 notification design → W7-D/E/F/G · W10-B docs-site decision · W10-D fork scope-down (gated on W7 outcome).
