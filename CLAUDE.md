...
- **TT #621 — Tab5↔K144 USB transport pivot via functionfs — DONE 2026-05-21** → [`docs/PLAN-usb-cdc-pivot.md`](docs/PLAN-usb-cdc-pivot.md) (TT #621 section) + LEARNINGS "TT #621".
...
- **TinkerON (K144) always-on wakeword (K144 own mic) — LIVE 2026-05-18** → [`docs/PLAN-wakeword.md`](docs/PLAN-wakeword.md), branch `feat/wakeword`, PR [#576](https://github.com/lorcan35/TinkerTab/pull/576), closes TT [#575](https://github.com/lorcan35/TinkerTab/issues/575).
