...
static void show_pane_async(void *arg) {
   (void)arg;
   ui_video_pane_show();
}
static void hide_pane_async(void *arg) {
   (void)arg;
   ui_video_pane_hide();
}
...
static void minimize_pane_async(void *arg) {
   (void)arg;
   ui_video_pane_minimize();
}
static void restore_pane_async(void *arg) {
   (void)arg;
...
void debug_server_call_register(httpd_handle_t server) {
   ...
   static const httpd_uri_t uri_video_stop = {.uri = "/video/stop", .method = HTTP_POST, .handler = video_stop_handler};
   static const httpd_uri_t uri_video_state = {.uri = "/video", .method = HTTP_GET, .handler = video_state_handler};
   static const httpd_uri_t uri_video_show = {.uri = "/video/show", .method = HTTP_POST, .handler = video_show_handler};
   static const httpd_uri_t uri_video_hide = {.uri = "/video/hide", .method = HTTP_POST, .handler = video_hide_handler};
   ...
   static const httpd_uri_t uri_call_mute = {.uri = "/call/mute", .method = HTTP_POST, .handler = call_mute_handler};
