...
static void paint_header_and_view_for_mode(uint8_t mode)
{
   ...
   {
      char llm[CHAT_LLM_MODEL_LEN] = {0};
      /* W1-E (TT #372): in vmode=5 SOLO_DIRECT the active model is
       * stored in or_mdl_llm (Tab5 → OpenRouter direct), NOT llm_mdl
       * (Dragon-routed cloud).  Without this, the chip showed the
